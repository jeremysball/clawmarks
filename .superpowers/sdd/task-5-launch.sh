#!/usr/bin/env bash
set -euo pipefail
BRIEF="/workspace/trent-with-smart-prompts/.superpowers/sdd/task-5-brief.md"
REPORT="/workspace/trent-with-smart-prompts/.superpowers/sdd/task-5-report.md"
...
opencode run \
  ...
  --print-logs \
  -f "$BRIEF" \
  -- "Task 4 is complete and was reviewed. Now implement Task 5.
