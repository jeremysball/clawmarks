#!/usr/bin/env bash
set -euo pipefail
BRIEF="/workspace/trent-with-smart-prompts/.superpowers/sdd/task-2-brief.md"
REPORT="/workspace/trent-with-smart-prompts/.superpowers/sdd/task-2-report.md"
...
opencode run \
  ...
  --print-logs \
  -f "$BRIEF" \
  -- "Task 1 is complete and was reviewed. Now implement Task 2.
